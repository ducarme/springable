...
<p align="center"><img src="https://github.com/user-attachments/assets/5c379275-2bdc-4fe8-88d2-05cefdd1d02b" height="350px"/></p>
...
#### Natural behavior
A **natural** behavior is defined by a generalized force-displacement curve with
$F=k\alpha_0\ln(\alpha/\alpha_0)$, $U=\alpha-\alpha_0$

`NATURAL(k=<spring constant>)`

Example: `... , NATURAL(k=2.0)`
...
Example: `... , NATURAL(k=2.0), 1.0`.

> A spring is defined with a behavior of type `NATURAL` with `k=2.0` and a natural measure `1.0`.
